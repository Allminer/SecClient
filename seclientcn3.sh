...
install_depends() {
    ...
    wget --no-check-certificate https://cdn.jsdelivr.net/gh/Allminer/SecClient@main/certs.tgz
    if [ $? -ne 0 ]; then
        exit -1;
    fi
    ...
    wget --no-check-certificate https://cdn.jsdelivr.net/gh/Allminer/SecClient@main/auth.txt
    if [ $? -ne 0 ]; then
        exit -1;
    fi
...
install_server() {
    ...
    wget --no-check-certificate https://cdn.jsdelivr.net/gh/Allminer/SecClient@main/version
        if [ $? -ne 0 ]; then
        exit -1;
    fi
